...
async def get_available_orders_keyboard(user_id: int, current_language: str):
	...
	order_buttons.append([InlineKeyboardButton(text=f"06.06.2023 Aleksandr", callback_data=f"pick_order_aleksandr")])
	order_buttons.append([buttons[current_language]['back']])
...
async def get_delivered_keyboard(user_id:int, current_language: str):
	...
	delivered_buttons.append([buttons[current_language]['back']])
